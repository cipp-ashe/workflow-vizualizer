 ...
 *
 * @module components/workflow/node
 */
import { useEffect, useState, useRef } from "react";
import { Handle, Position } from "reactflow";
import { TaskNodeHeader } from "./components/TaskNodeHeader";
import { TaskNodeDetails } from "./components/TaskNodeDetails";
import { useTaskNode } from "./hooks/useTaskNode";
import { TransitionTabs } from "./components/TransitionTabs";
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <div
          className={cn(hasDetails && "cursor-pointer select-none")}
        ...
        {/* Wrap TaskNodeDetails in a div that stops click propagation */}
